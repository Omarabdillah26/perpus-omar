...
<head>
    ...
    <title>Edit Kategori - Perpus Omar</title>
...
<body class="bg-[#fafafa] dark:bg-[#0f0f0f] text-[#1a1a1a] dark:text-[#f3f3f3] flex items-center justify-center min-h-screen p-4">
    <div class="w-full max-w-lg">
        <header class="mb-10 text-center">
            <h2 class="text-3xl font-bold mb-2 text-indigo-600">Edit Kategori</h2>
            <p class="text-gray-500">Perbarui informasi kategori koleksi buku.</p>
        </header>
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" id="name" name="name" required 
                               ...
                               placeholder="Contoh: Teknologi, Sejarah, Fiksi..." value="{{ old('name', $category->name) }}">
                        @error('name')
                    ...
                    <div class="flex gap-4 pt-4">
                        ...
                        <button type="submit" class="flex-2 py-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-2xl shadow-xl shadow-indigo-500/25 transition-all active:scale-95 font-bold">Perbarui Kategori</button>
                    </div>
                </div>
            </form>
        </div>
